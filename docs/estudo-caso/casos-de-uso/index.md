...
<iframe src="docs\assets\caso_de_uso_perfil_profissional.pdf" width="100%" height="600px" style="border: none; border-radius: 8px; box-shadow: 0 2px 8px rgba(0,0,0,0.1); margin: 16px 0;"></iframe>

<a href="docs\assets\caso_de_uso_perfil_profissional.pdf" target="_blank" style="display: inline-block; background: linear-gradient(135deg, #0052cc 0%, #003d99 100%); color: white; padding: 10px 20px; border-radius: 6px; text-decoration: none; font-weight: bold; margin: 10px 0; transition: all 0.3s ease; box-shadow: 0 2px 8px rgba(0, 52, 204, 0.2);">🔗 Abrir em Nova Aba</a>
...
<iframe src="docs\assets\gerenciamento_infos_medicas.pdf" width="100%" height="600px" style="border: none; border-radius: 8px; box-shadow: 0 2px 8px rgba(0,0,0,0.1); margin: 16px 0;"></iframe>

<a href="docs\assets\gerenciamento_infos_medicas.pdf" target="_blank" style="display: inline-block; background: linear-gradient(135deg, #0052cc 0%, #003d99 100%); color: white; padding: 10px 20px; border-radius: 6px; text-decoration: none; font-weight: bold; margin: 10px 0; transition: all 0.3s ease; box-shadow: 0 2px 8px rgba(0, 52, 204, 0.2);">🔗 Abrir em Nova Aba</a>

---

#### 4. Registro de campanhas de saúde

<iframe src="docs\assets\Registrar_campanhas.pdf" width="100%" height="600px" style="border: none; border-radius: 8px; box-shadow: 0 2px 8px rgba(0,0,0,0.1); margin: 16px 0;"></iframe>

<a href="docs\assets\Registrar_campanhas.pdf" target="_blank" style="display: inline-block; background: linear-gradient(135deg, #0052cc 0%, #003d99 100%); color: white; padding: 10px 20px; border-radius: 6px; text-decoration: none; font-weight: bold; margin: 10px 0; transition: all 0.3s ease; box-shadow: 0 2px 8px rgba(0, 52, 204, 0.2);">🔗 Abrir em Nova Aba</a>

---

#### 5. Busca por serviços de saúde

<iframe src="docs\assets\CasoDeUsoBuscar.pdf" width="100%" height="600px" style="border: none; border-radius: 8px; box-shadow: 0 2px 8px rgba(0,0,0,0.1); margin: 16px 0;"></iframe>

<a href="docs\assets\CasoDeUsoBuscar.pdf" target="_blank" style="display: inline-block; background: linear-gradient(135deg, #0052cc 0%, #003d99 100%); color: white; padding: 10px 20px; border-radius: 6px; text-decoration: none; font-weight: bold; margin: 10px 0; transition: all 0.3s ease; box-shadow: 0 2px 8px rgba(0, 52, 204, 0.2);">🔗 Abrir em Nova Aba</a>

---

#### 6. Consulta de prescrição médica

<iframe src="docs\assets\UC_Consultar_Prescricao_Medica.pdf" width="100%" height="600px" style="border: none; border-radius: 8px; box-shadow: 0 2px 8px rgba(0,0,0,0.1); margin: 16px 0;"></iframe>

<a href="docs\assets\UC_Consultar_Prescricao_Medica.pdf" target="_blank" style="display: inline-block; background: linear-gradient(135deg, #0052cc 0%, #003d99 100%); color: white; padding: 10px 20px; border-radius: 6px; text-decoration: none; font-weight: bold; margin: 10px 0; transition: all 0.3s ease; box-shadow: 0 2px 8px rgba(0, 52, 204, 0.2);">🔗 Abrir em Nova Aba</a>
